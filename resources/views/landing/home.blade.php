    ...
    <div class="section-popular-travel row justify-content-center">
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div
          ...
          style="background-image: url('{{asset('landing/images/travel-1.jpg')}}');"
        >
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div
          class="card-travel text-center d-flex flex-column"
          style="background-image: url('{{asset('landing/images/travel-2.jpg')}}');"
        >
          <div class="travel-country">INDONESIA</div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div
          class="card-travel text-center d-flex flex-column"
          style="background-image: url('{{asset('landing/images/travel-3.jpg')}}');"
        >
          <div class="travel-country">INDONESIA</div>
      ...
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div
          class="card-travel text-center d-flex flex-column"
          style="background-image: url('{{asset('landing/images/travel-4.jpg')}}');"
        >
          <div class="travel-country">INDONESIA</div>
